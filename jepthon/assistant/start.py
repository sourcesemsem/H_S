#    جميع الحقوق لمطوري سورس سيمو حصريا لهم فقط
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المـبـرمـجہ", "https://t.me/DEV_SAMIR"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب سـيـمـو ", data="deploy")],
                [Button.url("تحتاج مسـاعدة", "https://t.me/DEV_SAMIR")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("شرح التنصيب 📺", "https://t.me/FTTUTY/116")],
                [Button.url("جروب المساعدة", "https://t.me/FTTUTY")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @FTTUTY", alert=True)




@tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"rozname"))) 
async def settings(event):  #    قـسـم  الزغرفـة 
    if event.sender_id == bot.uid:
        await event.delete()
        await tgbot.send_message(event.chat_id,
