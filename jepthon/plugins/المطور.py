...
async def amireallyalive(event):
    ...
    CAT_IMG = "https://telegra.ph/file/972948abef63b2f59f11f.jpg"
    if CAT_IMG:
        CAT = [x for x in CAT_IMG.split()]
        A_IMG = list(CAT)
        PIC = random.choice(A_IMG)
        cat_caption = f"هـذا هـو مـطـور سـورس سـيـمـو\n"
        cat_caption += f"✛━━━[𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐌𝐎](https://t.me/FTTUTY)━━━✛\n\n"
        cat_caption += f"- مبـرمـجہ السورس :  [『 𝐃𝐄𝐕 𝐒𝐀𝐌𝐈𝐑 』➯](https://t.me/DEV_SAMIR)\n\n"
        cat_caption += f"- قـنـاة الـسـورس  : [『 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐄𝐌𝐎 』➯](https://t.me/FTTUTY)\n\n"
