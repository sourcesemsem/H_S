...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""هـݪا ححبيٰبيِ٘ {mention}  🕷.

ممڪن اڪون ﻧـاي٘مـم اﺎۅꪆ مـمشـشغۅꪆݪ 🕷.

اﺎتࢪڪ ࢪسساﺎݪتڪ ۅꪆاانتظـࢪ الـࢪد عٓݪي٘ڪ 🕷.

ݪاﺎتڪࢪࢪ عٓندڪ 6 تححذي٘ࢪاﺎت 🕷.
...
async def approve_p_m(event):
    ...
    await edit_or_reply(
        event,
        APPROVED_PMs,
        file_name="قائـمة الحـماية سيمو.txt",
